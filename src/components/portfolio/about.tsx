    ...
    <section id="about" className="py-40 relative bg-black/40 overflow-hidden">
      ...
      <div className="container mx-auto px-4 reveal">
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            <CardContent className="p-12 md:p-24 relative space-y-12">
              ...
              <div className="space-y-8 text-xl md:text-2xl text-white/80 leading-relaxed text-justify font-medium">
                ...
                <p>
                  Em <span className="text-white font-black bg-primary/10 px-2 rounded">2014</span>, descobri meu gosto para engenharia ao iniciar o curso de AutoCAD no SENAC. Meu desempenho foi tão destacado que recebi o convite do meu professor para integrar a sua empresa. Essa experiência foi vital e me ajudou na escolha da minha carreira.
                </p>
